...
function showAverage() {
    ...
    document.getElementById('averageResult').innerText = `Average: ${average}`; // Mostramos el resultado
}
...
function showReversedWords() {
    ...
    document.getElementById('reversedResult').innerText = `Reversed: ${reversed}`; // Mostramos el resultado
}
